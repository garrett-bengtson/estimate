...
@Configuration
@ComponentScan({ "edu.ndsu.cs.estimate" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "edu.ndsu.cs.estimate");
                servletContext.setInitParameter("tapestry.development-modules", "edu.ndsu.cs.estimate.services.DevelopmentModule");
